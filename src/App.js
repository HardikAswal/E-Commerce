...
class App extends React.Component {
  ...
  AddInfo(info){
    ...
    let obj ={name:"",price:"",picture:"",date: new Date(),id:Math.random().toString(36).replace(/[^a-z]+/g, '').substr(0, 15),description:"",style:"",neck:"",sleeve:"",sizeSelect:null,qtyS:0,qtyM:0,qtyL:0,qtyXL:0,men:false,women:false,kids:false};
